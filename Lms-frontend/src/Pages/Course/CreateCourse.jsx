        ...
        <HomeLayout>
            <div className="flex items-center justify-center h-[100vh]">
                ...
                >
                    ...
                    <h1 cla ssName="text-center text-2xl font-bold">
                        Create New Course
                    </h1>
                    ...
                    <main className="grid grid-cols-2 gap-x-10">
                        <div className="gap-y-6">
                            ...
                            <div className="flex flex-col gap-1">
                                <lable className="text-lg font-semibold" htmlFor="title">
                                    Course title
                                </lable> 
                                <input
                                    required
                        ...
                        <div className="flex flex-col gap-1">
                         <div className="flex flex-col gap-1">
                                <lable className="text-lg font-semibold" htmlFor="createdBy">
                                    Course Instructor
                                </lable> 
                                <input
                                    required
                             ...
                             <div className="flex flex-col gap-1">
                                <lable className="text-lg font-semibold" htmlFor="category">
                                    Course category
                                </lable> 
                                <input
                                    required
                             ...
                             <div className="flex flex-col gap-1">
                                <lable className="text-lg font-semibold" htmlFor="description">
                                    Course description
                                </lable> 
                                <textarea
                                    required
